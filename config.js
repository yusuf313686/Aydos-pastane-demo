...
═══════════════════════════════════════════════════════════════
  ...
  BEKLEYEN GİRDİLER (Fatih Bey'den):
  - Menü fiyatları ("—" olanlar). Sepet açık ama fiyatsız üründe
    toplam 0 TL görünür — fiyatlar gelince doldurulacak.
  - Adres teyidi: eski kayıt "1. Cad. No:64", Maps "Neşet Ertaş Cd 7/C-D"
  - Çalışma saati teyidi: eski 08:30–21:30, Maps 04:00–00:30
═══════════════════════════════════════════════════════════════
*/
const CONFIG = {
...
/* ── BÖLÜM 1 — SIK GÜNCELLENEN ── */
  ...
  orderForm: {
    ...
    candles: [],
    flavors: [
      "Çilek", "Muz", "Vişne", "Karışık Meyve",
      "Frambuaz", "Orman Meyvesi",
      "Beyaz Çikolata", "Bitter Çikolata", "Krokan",
      "Karamel", "Kestane"
    ],
    creams: ["Şantili", "Çikolatalı", "Karamelli", "Meyveli", "Vanilyalı"],
    notes: []
  },
